...
## Project directory:
# project_directory <- '/Users/vjs/research/cnn_residuals/'
...
## Data file:
data_path <- '/Users/tnye/kappa/data/flatfiles/ASK14_pga_model1.csv'
...
{  
  ...
  fixed_file <- paste(project_directory,"output/R_MEML/",location_name,"_fixed_",i_model_name,"_model1.txt",sep='')
  ...
  ## get the filepath, write the file
  event_file <- paste(project_directory,"output/R_MEML/",location_name,"_event_",i_model_name,"_model1.txt",sep='')
  ...
  ## get the filepath, write the file
  site_file <- paste(project_directory,"output/R_MEML/",location_name,"_site_",i_model_name,"_model1.txt",sep='')
