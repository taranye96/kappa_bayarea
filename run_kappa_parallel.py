...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 24 12:44:15 2022
...
model_name='model1_35'
home_dir = f'/Users/tnye/kappa/traditional_method/models/{model_name}'

spectra_dir = '/Users/tnye/kappa/data/spectra/acc_35'
...
if rank == 0:
    fulldata = np.arange(len(stations), dtype=int)
else:
    fulldata=None

# Number of items on each process
count = len(stations)//ncpus
...
final_df.to_csv('/Users/tnye/kappa/data/flatfiles/final_dataset.csv')
